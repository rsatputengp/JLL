...
app.controller('AD_User_Controller', function ($scope, $http, $document) {
    ...
    if (($scope.userRecord)) {
        ...
        if (($scope.userRecord.designation === "Risk Officer")) {
            ...
            // for HV Form view
            $scope.houseVerificationForm = function () {
                $scope.houseverification = false;
                $scope.centervisitreport = false;
                $scope.auditscoringreport = false;
                ...
                //form remarks field
                $scope.hvFormfilledBy = false;
                $scope.hvFormModifiedBy = false;

                //form button            
                $scope.HVsubmitButton = true;
                $scope.HVupdateButton = false;
            ...
            //for CVR Form view
            $scope.centerVisitReportForm = function () {
                $scope.houseverification = false;
                $scope.centervisitreport = false;
                $scope.auditscoringreport = false;
            ...
            //for ASR Form view
            $scope.auditScoringReportForm = function () {
                $scope.houseverification = false;
                $scope.centervisitreport = false;
                $scope.auditscoringreport = false;
                ...
                //form remarks field
                $scope.asrFormfilledBy = false;
                $scope.asrFormModifiedBy = false;

                //form button            
                $scope.ASRsubmitButton = true;
                $scope.ASRupdateButton = false;
            ...
            // for submitting HV form {"houseverification/create"}            
...
//                    
            ...
            // for submitting CVR form {"centervisitreport/create"} 
            ...
            // for submitting ASR form {"auditscoringreport/create"} 
